...
export const WorkoutControl = ( {
    ...
    return (
        <Row>
            ...
            <WorkoutButton {...common} id='inc5' hotkey='Shift+↑' text={loadButtons?.inc5 ?? '+5%'} onClick={()=>onInc(5)}/>
            <WorkoutButton {...common} id='inc1' hotkey='↑' text={loadButtons?.inc1 ?? '+1%'} onClick={()=>onInc(1)}/>
            <WorkoutButton {...common} id='dec1' hotkey='↓' text={loadButtons?.dec1 ?? '-1%'}onClick={()=>onDec(1)}/>
            <WorkoutButton {...common} id='dec5' hotkey='Shift+↓' text={loadButtons?.dec5 ?? '-5%'} onClick={()=>onDec(5)}/>
